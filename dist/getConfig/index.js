...
export const getConfig = ({ configPath, }) => pipe(getConfigWatch({ configPath }), S.take(1), S.runCollect, T.map(Chunk.unsafeHead), T.rightOrFail, OT.withSpan('@contentlayer2/core/getConfig:getConfig', { attributes: { configPath } }));
...
}), OT.withSpan('@contentlayer2/core/getConfig:getConfigFromResult', { attributes: { configPath } }), T.either);
/**
