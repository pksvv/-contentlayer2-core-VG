import { casesHandled, pattern } from '@contentlayer2/utils';
...
export const renderTypes = ({ schemaDef, generationOptions, }) => {
    ...
    const importsForRawTypes = pattern
        ...
        .with('local', () => `import * as Local from 'contentlayer2/source-files'`)
        .with('contentful', () => `import * as Contentful from '@contentlayer2/source-contentful'`)
        .otherwise(() => ``);
...
const indent = (spaceCount) => (str) => `${' '.repeat(spaceCount)}${str}`;
